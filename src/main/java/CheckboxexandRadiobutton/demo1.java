...
//			  WebElement localbx = checkboxes.get(i);
...
//		  }
		  ...
		  for(WebElement ele :checkboxes) {
           String vals = ele.getAttribute("value");
			  System.out.println("valyes from checkboxes are : "+vals);
			  
			  if(vals.equalsIgnoreCase("Automation Testing")){
				  System.out.println("Congrats Shiva for Shortlisting : " +vals);
				  ele.click();
			  }
		  }
